...
export const Navbar: React.FC = () => {
  ...
  return (
    <>
      ...
      >
        <div className="max-w-7xl mx-auto px-5 sm:px-8 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3 lg:hidden">
            <Link
              href="/demo"
              className="font-mono text-[11px] tracking-wider px-3 py-2 min-h-[44px] flex items-center bg-[#F5F5F5] text-[#080808] font-bold rounded-xs"
            >
              DEMO
            </Link>
            <button
              onClick={() => setIsMobileMenuOpen(true)}
              className="p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center text-[#F5F5F5] hover:text-white focus:outline-none focus-visible:ring-1 focus-visible:ring-[#F5F5F5]"
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-50 bg-[#080808] flex flex-col justify-between p-6 sm:p-10 pt-[calc(1.5rem+env(safe-area-inset-top,0px))] pb-[calc(1.5rem+env(safe-area-inset-bottom,0px))] pl-[calc(1.5rem+env(safe-area-inset-left,0px))] pr-[calc(1.5rem+env(safe-area-inset-right,0px))] animate-in fade-in duration-300 overflow-y-auto">
          <div className="flex items-center justify-between border-b border-[#1A1A1A] pb-6">
            ...
            <button
              onClick={() => setIsMobileMenuOpen(false)}
              className="p-2.5 min-w-[44px] min-h-[44px] flex items-center justify-center text-[#888888] hover:text-[#F5F5F5] focus:outline-none focus-visible:ring-1 focus-visible:ring-[#F5F5F5]"
            ...
            {[
              ...
              <div key={link.path} className="overflow-hidden">
                <Link
                  href={link.path}
                  onClick={() => setIsMobileMenuOpen(false)}
                  className={`block py-1 min-h-[44px] font-display font-bold text-3xl sm:text-4xl tracking-wider hover:text-white transition-colors ${
