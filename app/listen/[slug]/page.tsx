...
export default function SmartLinkPage({ params }: PageProps) {
  ...
  return (
    <div className="min-h-[85vh] flex items-center justify-center py-6 sm:py-12 px-3 sm:px-6">
      <div className="w-full max-w-lg bg-[#0A0A0A] border border-[#1F1F1F] p-4 sm:p-8 space-y-6 sm:space-y-8 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex items-center justify-between text-xs font-mono text-[#888888] border-b border-[#181818] pb-3 sm:pb-4">
          <Link
            href={`/release/${release.slug}`}
            className="inline-flex items-center gap-1.5 hover:text-[#F5F5F5] transition-colors uppercase min-h-[36px] py-1"
          >
            <ArrowLeft size={12} />
          ...
          <button
            ...
            className="flex items-center gap-1.5 px-3 py-1.5 min-h-[36px] bg-[#141414] border border-[#222222] hover:border-[#444444] text-[#CCCCCC] transition-colors"
        ...
        <div className="text-center space-y-3 sm:space-y-4">
          <div className="relative aspect-square max-w-[240px] sm:max-w-[320px] mx-auto border border-[#262626] shadow-2xl overflow-hidden group">
            <img
          ...
          <div className="space-y-1 pt-1 sm:pt-2">
            <h1 className="font-display font-black text-[clamp(1.5rem,4.5vw,2rem)] text-[#F5F5F5] uppercase tracking-tight leading-tight">
              {release.title}
            </h1>
            <p className="font-serif italic text-base sm:text-lg text-[#CCCCCC]">
              ...
              {activePlatforms.map((p) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full p-3 sm:p-3.5 min-h-[56px] bg-[#121212] border border-[#222222] ${p.bgHover} transition-all flex items-center justify-between group text-left cursor-pointer`}
                  >
