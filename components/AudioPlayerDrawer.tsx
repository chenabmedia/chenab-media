...
export const AudioPlayerDrawer: React.FC = () => {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-[#111111]/95 backdrop-blur-lg border-t border-[#222222] px-6 py-4 transition-all duration-300 shadow-2xl">
      <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
        ...
        <div className="flex-1 max-w-md hidden md:flex flex-col items-center gap-1.5 px-4">
          <div className="flex items-center gap-4">
            <button
              onClick={togglePlay}
              className="p-2.5 rounded-full bg-[#F5F5F5] text-[#080808] hover:bg-white transition-colors"
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={togglePlay}
            className="md:hidden p-2 rounded-full bg-[#F5F5F5] text-[#080808]"
          >
          ...
          <button
            ...
            className="hidden sm:p-2 text-[#888888] hover:text-[#F5F5F5] transition-colors"
          ...
          <button
            onClick={pauseTrack}
            className="p-2 text-[#777777] hover:text-[#F5F5F5] transition-colors"
            title="Close Player"
          >
            <X size={20} />
          </button>
