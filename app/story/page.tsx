...
export default function StoryPage() {
  return (
    <div className="max-w-5xl mx-auto px-6 sm:px-8 py-16 space-y-20">
      <div className="space-y-6 border-b border-[#1C1C1C] pb-12">
        ...
        <h1 className="font-display font-black text-5xl sm:text-7xl text-[#F5F5F5] tracking-tight uppercase leading-none">
          THE CHENAB MANIFESTO
        </h1>
        <p className="font-serif italic text-2xl sm:text-3xl text-[#D0D0D0] leading-snug">
      ...
      <section className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start">
        ...
        <div className="md:col-span-8 space-y-6 font-sans text-base text-[#CCCCCC] leading-relaxed">
          <p>
      ...
      <section className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start border-t border-[#1A1A1A] pt-16">
        <div className="md:col-span-4 font-mono text-xs text-[#888888] uppercase tracking-widest">
      ...
      <section className="grid grid-cols-1 md:grid-cols-12 gap-8 items-start border-t border-[#1A1A1A] pt-16">
        ...
        <div className="md:col-span-8 space-y-6 font-sans text-base text-[#CCCCCC] leading-relaxed">
          ...
          <div className="pt-8 flex flex-wrap items-center gap-6 font-mono text-xs">
            <Link
              href="/releases"
              className="px-6 py-3 bg-[#F5F5F5] text-[#080808] font-bold uppercase hover:bg-white transition-colors"
            >
              EXPLORE CATALOGUE
            </Link>
            <Link
              href="/demo"
              className="px-6 py-3 border border-[#333333] text-[#F5F5F5] uppercase hover:border-[#666666] transition-colors"
            >
              SUBMIT DEMO
            </Link>
          </div>
