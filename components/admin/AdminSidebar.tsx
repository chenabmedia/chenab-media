...
export function AdminSidebar({
  ...
  return (
    <>
      ...
      {/* Sidebar Container */}
      <aside
        className={`fixed top-0 bottom-0 left-0 z-50 w-64 bg-[#0A0A0A] border-r border-[#1C1C1C] flex flex-col justify-between transition-transform duration-300 ease-in-out lg:translate-x-0 ${
      ...
      >
        ...
        <div className="p-6 border-b border-[#1A1A1A] flex items-center justify-between">
          ...
          <button
            onClick={() => setMobileOpen(false)}
            className="lg:hidden p-1.5 text-[#888888] hover:text-[#F5F5F5] border border-[#222222] bg-[#111111]"
          >
            <X size={16} />
          </button>
        </div>
