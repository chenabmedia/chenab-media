      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        <div className="lg:col-span-5 space-y-8">
          <div className="relative aspect-square overflow-hidden bg-[#151515] border border-[#222222] shadow-2xl group">
            ...
            />
            <div className="absolute top-4 left-4 bg-[#080808]/90 backdrop-blur-md px-3 py-1 font-mono text-xs text-[#F5F5F5] border border-[#222222]">
              {release.catalogueNumber}
            </div>
            <div className="absolute top-4 right-4 bg-[#080808]/90 backdrop-blur-md px-2.5 py-1 font-mono text-[10px] text-[#888888] border border-[#222222] uppercase">
              {release.status}
            </div>
          </div>
        ...
        <div className="lg:col-span-7 space-y-10">
          <div className="space-y-4 border-b border-[#1C1C1C] pb-8">
            <div className="flex flex-wrap items-center gap-3 font-mono text-xs text-[#888888]">
            ...
            <h2 className="font-serif italic text-2xl sm:text-3xl text-[#D0D0D0]">
              by{' '}
              {artistSlug ? (
            ...
            <div className="divide-y divide-[#181818] border border-[#1A1A1A] bg-[#0C0C0C]">
              {release.tracks && release.tracks.map((tr) => {
                ...
                return (
                  <div
                    key={tr.id}
                    className="p-4 flex items-center justify-between hover:bg-[#111111] transition-colors group"
                  >
                    <div className="flex items-center gap-4">
                      <button
                        ...
                        className="w-8 h-8 rounded-full border border-[#333333] flex items-center justify-center text-[#F5F5F5] hover:border-[#666666] hover:bg-[#1A1A1A] transition-all"
                    ...
                    <span className="font-mono text-xs text-[#777777]">{tr.duration}</span>
                  </div>
                );
              })}
            </div>
          ...
          <div className="space-y-4 pt-6 border-t border-[#1C1C1C]">
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                target="_blank"
                className="px-3 py-1.5 bg-[#181818] border border-[#333333] hover:border-[#666666] text-[#F5F5F5] font-mono text-[11px] uppercase flex items-center gap-1.5"
              >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3 font-mono text-xs">
              {(release.streamingLinks?.spotify || release.dspLinks?.spotify) && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="px-4 py-3 border border-[#222222] bg-[#0C0C0C] hover:border-[#666666] hover:bg-[#111111] text-[#F5F5F5] flex items-center justify-between transition-all"
                >
                  <span>SPOTIFY</span>
